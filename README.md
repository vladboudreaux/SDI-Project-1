...
### Installation Instructions
    1. Clone this repository, or download the .zip under the "Code" button
    2. Unzip, or open the cloned folder
    3. Double click "index.html" or run it with live server if viewing in VScode.
    4. Have fun!
